function Initialize()
    ...
    -- Getting the user variables from the previous folder
    userVarsPath = awesomeUserFolder .. "variables.inc"
    if fileExists(userVarsPath) == false then
        -- If theres no user variables file, then we run a functino to create then
